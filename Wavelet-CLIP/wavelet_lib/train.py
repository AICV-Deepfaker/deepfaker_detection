...
def prepare_training_data(config):
    ...
    frames, labels, names = train_set.collect_img_and_label_for_one_dataset("GAN-DIFFUSION")
    print("[DEBUG] train set check")
    print(len(frames), len(labels))
    print(frames[0], labels[0], names[0])
...
def main():
    ...
    with open('/content/Wavelet-CLIP/training/config/train_config.yaml', 'r') as f:
